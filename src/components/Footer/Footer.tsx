    ...
    <>
      <div className='footerInicio'>
        <IonButton
          ...
          fill='clear'
        >
          <IonIcon className={active==="profile"? 'iconos active' : 'iconos'} icon={person} />
        </IonButton>
        <IonButton 
        onClick={() => history.push("/inicio")}
        className='iconosB' 
        fill='clear'>
          <IonIcon className={active==="inicio"? 'iconos active' : 'iconos'} icon={home} />
        </IonButton>
        <IonButton 
        onClick={() => history.push("/chat")}
        className='iconosB' 
        fill='clear'>
          <IonIcon className={active==="chat"? 'iconos active' : 'iconos'} icon={mail} />
        </IonButton>
      </div>
    </>
  );
